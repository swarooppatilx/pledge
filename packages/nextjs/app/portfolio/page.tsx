...
import { ProjectAvatar, StatBanner } from "~~/components/ui";
    ...
    <div className="min-h-screen bg-[#0D0D0D] page-enter">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <div className="text-price-big text-white mb-2">{parseFloat(formatEther(totalValue)).toFixed(4)} ETH</div>
        ...
        <StatBanner
          items={[
            {
              label: "Total Value",
              value: `${parseFloat(formatEther(totalValue)).toFixed(4)} ETH`,
              trend: "Redeemable",
              trendType: "neutral",
            },
            {
              ...
              trend: `${activeHoldings} active`,
              trendType: "positive",
            },
            {
              label: "Total Shares",
              value: Number(totalShares / BigInt(1e18)).toLocaleString(),
              trend: "Across pledges",
              trendType: "neutral",
            },
          ]}
          className="mb-8"
          ...
          <div className="space-y-3">
            {sortedHoldings.map(holding => {
              const statusColors = {
                ...
                [PledgeStatus.Cancelled]: "bg-[rgba(255,67,67,0.1)] text-[#FF4343]",
              };
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-4">
                    <ProjectAvatar address={holding.pledge} name={holding.name} size="lg" />
                    <div>
                  ...
                  <div className="flex items-center gap-8">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-mono text-[#9B9B9B]">{holding.ownershipPercent.toFixed(2)}%</div>
                    </div>
